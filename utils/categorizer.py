...
CATEGORIES = {
    ...
    "Напоминания": ["напомни", "напомнить", "напоминание", "напоминай", "через", "минут", "часов", "дней", "августа", "сентября", "октября", "ноября", "декабря", "января", "февраля", "марта", "апреля", "мая", "июня", "июля", "день рождения", "др"],
    "Прочее": []
}
