...
async def cmd_categories(message: Message, database):
    """Обработчик команды /категории - показать все категории"""
    try:
        ...
        response += "/добавитькатегорию Название:ключ1,ключ2,ключ3\n\n"
        response += "Пример: /добавитькатегорию Работа:проект,задача,дедлайн"
